...
from build_models import build_models, build_direct_emulator
...
class DirectEmulator:
    def __init__(self, direct_emulator=None):
        ...
        if direct_emulator:
            ...
            self.direct_emulator = tf.keras.models.load_model('models/direct_emulator.h5',
    ...
    def train(self, **kwargs):
        ...
        direct_emulator = build_direct_emulator(self.direct_em_dims, self.signal_train, self.par_train,
