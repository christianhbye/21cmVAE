...
Recommended: matplotlib, jupyter (required for the sample notebooks).
...
To install the recommended packages (matplotlib and jupyter) as well, you should instead do:
