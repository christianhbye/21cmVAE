...
best_layer_hps = np.load('results_trial_'+str(best_trial)+'_layer_hps.npy', allow_pickle=True)
...
em_loss, em_loss_val = train_emulator(tuned_em, signal_train, signal_val, par_train, par_val, EPOCHS, em_lr, em_lr_factor,
